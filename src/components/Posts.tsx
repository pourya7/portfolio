        ...
        <section class="container mx-auto">
            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-8 lg:grid-cols-2 xl:grid-cols-2 mt-16">
                <article>
                    ...
                    <p class="mt-4 text-lg sm:text-sm text-gray-800 dark:text-gray-200">
                ...
                <div class="grid grid-cols-1 gap-y-8">
                    ...
                    <article>
                        <time datetime="2019-04-11" class="block text-gray-600 dark:text-gray-400">Apr 11, 2019</time>
                        <h2 class="mt-2 text-gray-800 dark:text-gray-100 md:text-2xl font-bold">
