...
export default component$<Props>(({ posts }) => {
    ...
    return (
        <section class="container mx-auto">
            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-8 lg:grid-cols-2 xl:grid-cols-2 mt-16">
                {featured && (
                    <a href={`/blog/${featured.id}`} class="block no-underline text-inherit hover:opacity-80 transition-opacity">
                        <article>
                            <time class="block text-gray-600 dark:text-gray-400">
                            ...
                            <div class="flex mt-4">
                                <span class="text-md font-medium text-blue-500 dark:text-blue-400">
                ...
                <div class="grid grid-cols-1 gap-y-8">
                    {rest.map((post, index) => (
                        <>
                            ...
                            <a href={`/blog/${post.id}`} class="block no-underline text-inherit hover:opacity-80 transition-opacity">
                                <article>
                                    <time class="block text-gray-600 dark:text-gray-400">
            ...
            <div class="text-center mt-12">
                <a href="/blog" class="inline-block bg-blue-500 text-white px-6 py-2 rounded hover:bg-blue-600 transition-colors font-medium">
                    View all posts →
                </a>
            </div>
        </section>
